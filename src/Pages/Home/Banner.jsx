  ...
  return (
    <div>
      <div
        ...
        className="w-full min-h-[80vh] md:min-h-0 md:h-[84vh] flex flex-col items-center justify-center gap-5 lg:gap-10 bg-cover bg-center before:absolute before:bg-black/60 before:inset-0 transform duration-1000 ease-linear"
